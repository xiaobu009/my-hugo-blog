...
![ns-email001.webp](ns-email001.webp)
...
![ns-email002.webp](ns-email002.webp)

![ns-email003.webp](ns-email003.webp)

### 2、打开邮箱验证选项卡

在“**Contact Manager**”页面，点击“**Email Verification Manager**”（邮箱验证管理）标签

![ns-email004.webp](ns-email004.webp)

### 3、查看邮箱验证状态

往下拉看到注册的邮箱，如果还未验证会看到邮箱图标，如果已经验证这里显示Verified。

![ns-email005.webp](ns-email005.webp)

![ns-email006.webp](ns-email006.webp)
...
![ns-email007.webp](ns-email007.webp)
...
![ns-email008.webp](ns-email008.webp)
...
![ns-doman-lock- 001.webp](ns-doman-lock-_001.webp)

### 2、选择要解锁的域名

在域名列表中，找到要转移的域名并点击进入。

![ns-doman-lock- 002.webp](ns-doman-lock-_002.webp)

### 3、解锁域名

查看锁图标：如果是**绿色**（**锁定**），点击图标切换为灰色（**解锁**）。

![ns-doman-lock- 003.webp](ns-doman-lock-_003.webp)

![ns-doman-lock- 004.webp](ns-doman-lock-_004.webp)

![ns-doman-lock- 005.webp](ns-doman-lock-_005.webp)

## 第四步、选中域名：

返回域名列表，在域名左侧的复选框中勾选要转移的域名（支持多选）。

![ns-push- 001.webp](ns-push-_001.webp)

## 第五步、发起推送：

在页面顶部“ACTIONS for Selected Domains”部分，点击“**Push Domains**”图标（推送域名）。

![ns-push- 002.webp](ns-push-_002.webp)
...
![ns-push- 003.webp](ns-push-_003.webp)
...
![ns-push- 010.webp](ns-push-_010.webp)

### 2、进入账户管理页面

**点击“Account Settings”** 或 “**Manage”**

![ns-push- 004.webp](ns-push-_004.webp)

### 3、打开安全选项卡（“Securiy”）

![ns-push- 005.webp](ns-push-_005.webp)

### 4、查看用户名

这里看到的才是推送域名要用到的用户名。这里一定要与接收方确认清楚。

![ns-push- 006.webp](ns-push-_006.webp)

## 第七步、确认转移：

点击“**SUBMIT**”确认提交后，系统会立即处理，域名会转移到接收账户。发送账户中能看到发送成功提示。接收方可在他们的Domain Manager中看到域名，并可自定义设置（如DNS、隐私保护）。

![ns-push- 008.webp](ns-push-_008.webp)

![ns-push- 007.webp](ns-push-_007.webp)

看到如下提示说明域名以及成功推送到对方的NameSilo账户中

![ns-push- 009.webp](ns-push-_009.webp)
...
**6、Elevenlabs AI生成语音**：[https://try.elevenlabs.io/6xlgbhoqxkc8](https://try.elevenlabs.io/6xlgbhoqxkc8)<br>