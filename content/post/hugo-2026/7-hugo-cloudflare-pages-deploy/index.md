...
3. 使用Github Desktop工具管理Git仓库
> Github Desktop是Github自主开发的免费Git仓库管理工具。
...
1. 登录 [Cloudflare Dashboard](https://dash.cloudflare.com/)，在左侧导航栏选择 **Compute** 下的 **Workers & Pages**。
2. 点击 **Create (创建应用程序)**，选择下方 **想要部署 Pages？开始使用 -> 导入现有 Git 存储库**。
